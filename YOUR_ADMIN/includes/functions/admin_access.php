...
{
  global $db;
//-bof-lat9 Retrieve last_login_date and last_login_ip too
...
{
  global $db;
//-bof-lat9 Reset session variables that contain last login date and IP address
...
//-bof-lat9 Set last login date and IP into session variables
